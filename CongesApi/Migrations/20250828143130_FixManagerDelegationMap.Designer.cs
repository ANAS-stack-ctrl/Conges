...
namespace CongesApi.Migrations
{
    ...
    [Migration("20250828143130_FixManagerDelegationMap")]
    partial class FixManagerDelegationMap
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CongesApi.Model.ManagerDelegation", b =>
                {
                    b.Property<int>("ManagerDelegationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ManagerDelegationId"));
                    ...
                    b.Property<int>("DelegateManagerUserId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DelegateManagerUserId");

                    b.HasIndex("ManagerUserId");

                    b.HasIndex("HierarchyId", "DelegateManagerUserId", "Active");

                    b.HasIndex("HierarchyId", "ManagerUserId", "Active");

                    b.HasIndex("HierarchyId", "ManagerUserId", "DelegateManagerUserId", "StartDate", "EndDate")
                        .IsUnique();
